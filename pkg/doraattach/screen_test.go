...
func TestCellAttrToSGR_MultipleAttrs(t *testing.T) {
	cell := xterm.NewCellData()
	cell.Fg = xterm.FgFlagBold | xterm.AttrCMP16 | 3
	cell.Bg = xterm.BgFlagItalic
	got := cellAttrToSGR(cell)
