...
func ActivityCommand(w *dshutil.WshRpc, data dshrpc.ActivityUpdate, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "activity", data, opts)
	return err
}

// command "aisendmessage", dshserver.AiSendMessageCommand
func AiSendMessageCommand(w *dshutil.WshRpc, data dshrpc.AiMessageData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "aisendmessage", data, opts)
	return err
}

// command "authenticate", dshserver.AuthenticateCommand
func AuthenticateCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) (dshrpc.CommandAuthenticateRtnData, error) {
...
func AuthenticateJobManagerCommand(w *dshutil.WshRpc, data dshrpc.CommandAuthenticateJobManagerData, opts *dshrpc.RpcOpts) error {
...
func AuthenticateJobManagerVerifyCommand(w *dshutil.WshRpc, data dshrpc.CommandAuthenticateJobManagerData, opts *dshrpc.RpcOpts) error {
...
func AuthenticateToJobManagerCommand(w *dshutil.WshRpc, data dshrpc.CommandAuthenticateToJobData, opts *dshrpc.RpcOpts) error {
...
func AuthenticateTokenCommand(w *dshutil.WshRpc, data dshrpc.CommandAuthenticateTokenData, opts *dshrpc.RpcOpts) (dshrpc.CommandAuthenticateRtnData, error) {
...
func AuthenticateTokenVerifyCommand(w *dshutil.WshRpc, data dshrpc.CommandAuthenticateTokenData, opts *dshrpc.RpcOpts) (dshrpc.CommandAuthenticateRtnData, error) {
...
func BadgeWatchPidCommand(w *dshutil.WshRpc, data dshrpc.CommandBadgeWatchPidData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "badgewatchpid", data, opts)
	return err
}

// command "blockinfo", dshserver.BlockInfoCommand
func BlockInfoCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) (*dshrpc.BlockInfoData, error) {
...
func BlockJobStatusCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) (*dshrpc.BlockJobStatusData, error) {
...
func BlocksListCommand(w *dshutil.WshRpc, data dshrpc.BlocksListRequest, opts *dshrpc.RpcOpts) ([]dshrpc.BlocksListEntry, error) {
...
func CaptureBlockScreenshotCommand(w *dshutil.WshRpc, data dshrpc.CommandCaptureBlockScreenshotData, opts *dshrpc.RpcOpts) (string, error) {
...
func CheckGoVersionCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (*dshrpc.CommandCheckGoVersionRtnData, error) {
...
func ConnUpdateWshCommand(w *dshutil.WshRpc, data dshrpc.RemoteInfo, opts *dshrpc.RpcOpts) (bool, error) {
...
func ControlGetRouteIdCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (string, error) {
...
func ControllerAppendOutputCommand(w *dshutil.WshRpc, data dshrpc.CommandControllerAppendOutputData, opts *dshrpc.RpcOpts) error {
...
func ControllerDestroyCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "controllerdestroy", data, opts)
	return err
}

// command "controllerinput", dshserver.ControllerInputCommand
func ControllerInputCommand(w *dshutil.WshRpc, data dshrpc.CommandBlockInputData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "controllerinput", data, opts)
	return err
}

// command "controllerresync", dshserver.ControllerResyncCommand
func ControllerResyncCommand(w *dshutil.WshRpc, data dshrpc.CommandControllerResyncData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "controllerresync", data, opts)
	return err
}

// command "createblock", dshserver.CreateBlockCommand
func CreateBlockCommand(w *dshutil.WshRpc, data dshrpc.CommandCreateBlockData, opts *dshrpc.RpcOpts) (doraobj.ORef, error) {
...
func CreateSubBlockCommand(w *dshutil.WshRpc, data dshrpc.CommandCreateSubBlockData, opts *dshrpc.RpcOpts) (doraobj.ORef, error) {
	resp, err := sendRpcRequestCallHelper[doraobj.ORef](w, "createsubblock", data, opts)
	return resp, err
}

// command "debugterm", dshserver.DebugTermCommand
func DebugTermCommand(w *dshutil.WshRpc, data dshrpc.CommandDebugTermData, opts *dshrpc.RpcOpts) (*dshrpc.CommandDebugTermRtnData, error) {
...
func ElectronDecryptCommand(w *dshutil.WshRpc, data dshrpc.CommandElectronDecryptData, opts *dshrpc.RpcOpts) (*dshrpc.CommandElectronDecryptRtnData, error) {
...
func ElectronEncryptCommand(w *dshutil.WshRpc, data dshrpc.CommandElectronEncryptData, opts *dshrpc.RpcOpts) (*dshrpc.CommandElectronEncryptRtnData, error) {
...
func ElectronSystemBellCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "electronsystembell", nil, opts)
	return err
}

// command "eventpublish", dshserver.EventPublishCommand
func EventPublishCommand(w *dshutil.WshRpc, data dps.WaveEvent, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "eventpublish", data, opts)
	return err
}

// command "eventreadhistory", dshserver.EventReadHistoryCommand
func EventReadHistoryCommand(w *dshutil.WshRpc, data dshrpc.CommandEventReadHistoryData, opts *dshrpc.RpcOpts) ([]*dps.WaveEvent, error) {
	resp, err := sendRpcRequestCallHelper[[]*dps.WaveEvent](w, "eventreadhistory", data, opts)
	return resp, err
}

// command "eventrecv", dshserver.EventRecvCommand
func EventRecvCommand(w *dshutil.WshRpc, data dps.WaveEvent, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "eventrecv", data, opts)
	return err
}

// command "eventsub", dshserver.EventSubCommand
func EventSubCommand(w *dshutil.WshRpc, data dps.SubscriptionRequest, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "eventsub", data, opts)
	return err
}

// command "eventunsub", dshserver.EventUnsubCommand
func EventUnsubCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "eventunsub", data, opts)
	return err
}

// command "eventunsuball", dshserver.EventUnsubAllCommand
func EventUnsubAllCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "eventunsuball", nil, opts)
	return err
}

// command "fetchsuggestions", dshserver.FetchSuggestionsCommand
func FetchSuggestionsCommand(w *dshutil.WshRpc, data dshrpc.FetchSuggestionsData, opts *dshrpc.RpcOpts) (*dshrpc.FetchSuggestionsResponse, error) {
...
func FileAppendCommand(w *dshutil.WshRpc, data dshrpc.FileData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "fileappend", data, opts)
	return err
}

// command "filecopy", dshserver.FileCopyCommand
func FileCopyCommand(w *dshutil.WshRpc, data dshrpc.CommandFileCopyData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "filecopy", data, opts)
	return err
}

// command "filecreate", dshserver.FileCreateCommand
func FileCreateCommand(w *dshutil.WshRpc, data dshrpc.FileData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "filecreate", data, opts)
	return err
}

// command "filedelete", dshserver.FileDeleteCommand
func FileDeleteCommand(w *dshutil.WshRpc, data dshrpc.CommandDeleteFileData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "filedelete", data, opts)
	return err
}

// command "fileinfo", dshserver.FileInfoCommand
func FileInfoCommand(w *dshutil.WshRpc, data dshrpc.FileData, opts *dshrpc.RpcOpts) (*dshrpc.FileInfo, error) {
	resp, err := sendRpcRequestCallHelper[*dshrpc.FileInfo](w, "fileinfo", data, opts)
	return resp, err
}

// command "filejoin", dshserver.FileJoinCommand
func FileJoinCommand(w *dshutil.WshRpc, data []string, opts *dshrpc.RpcOpts) (*dshrpc.FileInfo, error) {
	resp, err := sendRpcRequestCallHelper[*dshrpc.FileInfo](w, "filejoin", data, opts)
	return resp, err
}

// command "filelist", dshserver.FileListCommand
func FileListCommand(w *dshutil.WshRpc, data dshrpc.FileListData, opts *dshrpc.RpcOpts) ([]*dshrpc.FileInfo, error) {
...
func FileListStreamCommand(w *dshutil.WshRpc, data dshrpc.FileListData, opts *dshrpc.RpcOpts) chan dshrpc.RespOrErrorUnion[dshrpc.CommandRemoteListEntriesRtnData] {
...
func FileMkdirCommand(w *dshutil.WshRpc, data dshrpc.FileData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "filemkdir", data, opts)
	return err
}

// command "filemove", dshserver.FileMoveCommand
func FileMoveCommand(w *dshutil.WshRpc, data dshrpc.CommandFileCopyData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "filemove", data, opts)
	return err
}

// command "fileread", dshserver.FileReadCommand
func FileReadCommand(w *dshutil.WshRpc, data dshrpc.FileData, opts *dshrpc.RpcOpts) (*dshrpc.FileData, error) {
...
func FileRestoreBackupCommand(w *dshutil.WshRpc, data dshrpc.CommandFileRestoreBackupData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "filerestorebackup", data, opts)
	return err
}

// command "filestream", dshserver.FileStreamCommand
func FileStreamCommand(w *dshutil.WshRpc, data dshrpc.CommandFileStreamData, opts *dshrpc.RpcOpts) (*dshrpc.FileInfo, error) {
	resp, err := sendRpcRequestCallHelper[*dshrpc.FileInfo](w, "filestream", data, opts)
	return resp, err
}

// command "filewrite", dshserver.FileWriteCommand
func FileWriteCommand(w *dshutil.WshRpc, data dshrpc.FileData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "filewrite", data, opts)
	return err
}

// command "findgitbash", dshserver.FindGitBashCommand
func FindGitBashCommand(w *dshutil.WshRpc, data bool, opts *dshrpc.RpcOpts) (string, error) {
	resp, err := sendRpcRequestCallHelper[string](w, "findgitbash", data, opts)
	return resp, err
}

// command "focuswindow", dshserver.FocusWindowCommand
func FocusWindowCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "focuswindow", data, opts)
	return err
}

// command "getallbadges", dshserver.GetAllBadgesCommand
func GetAllBadgesCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]baseds.BadgeEvent, error) {
...
func GetAllVarsCommand(w *dshutil.WshRpc, data dshrpc.CommandVarData, opts *dshrpc.RpcOpts) ([]dshrpc.CommandVarResponseData, error) {
...
func GetBuilderOutputCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) ([]string, error) {
...
func GetBuilderStatusCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) (*dshrpc.BuilderStatusData, error) {
...
func GetFocusedBlockDataCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (*dshrpc.FocusedBlockData, error) {
...
func GetFullConfigCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (dconfig.FullConfigType, error) {
...
func GetJwtPublicKeyCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (string, error) {
	resp, err := sendRpcRequestCallHelper[string](w, "getjwtpublickey", nil, opts)
	return resp, err
}

// command "getmeta", dshserver.GetMetaCommand
func GetMetaCommand(w *dshutil.WshRpc, data dshrpc.CommandGetMetaData, opts *dshrpc.RpcOpts) (doraobj.MetaMapType, error) {
	resp, err := sendRpcRequestCallHelper[doraobj.MetaMapType](w, "getmeta", data, opts)
	return resp, err
}

// command "getrtinfo", dshserver.GetRTInfoCommand
func GetRTInfoCommand(w *dshutil.WshRpc, data dshrpc.CommandGetRTInfoData, opts *dshrpc.RpcOpts) (*doraobj.ObjRTInfo, error) {
	resp, err := sendRpcRequestCallHelper[*doraobj.ObjRTInfo](w, "getrtinfo", data, opts)
	return resp, err
}

// command "getsecrets", dshserver.GetSecretsCommand
func GetSecretsCommand(w *dshutil.WshRpc, data []string, opts *dshrpc.RpcOpts) (map[string]string, error) {
...
func GetSecretsLinuxStorageBackendCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (string, error) {
...
func GetSecretsNamesCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]string, error) {
	resp, err := sendRpcRequestCallHelper[[]string](w, "getsecretsnames", nil, opts)
	return resp, err
}

// command "gettab", dshserver.GetTabCommand
func GetTabCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) (*doraobj.Tab, error) {
	resp, err := sendRpcRequestCallHelper[*doraobj.Tab](w, "gettab", data, opts)
	return resp, err
}

// command "gettempdir", dshserver.GetTempDirCommand
func GetTempDirCommand(w *dshutil.WshRpc, data dshrpc.CommandGetTempDirData, opts *dshrpc.RpcOpts) (string, error) {
...
func GetUpdateChannelCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (string, error) {
	resp, err := sendRpcRequestCallHelper[string](w, "getupdatechannel", nil, opts)
	return resp, err
}

// command "getvar", dshserver.GetVarCommand
func GetVarCommand(w *dshutil.WshRpc, data dshrpc.CommandVarData, opts *dshrpc.RpcOpts) (*dshrpc.CommandVarResponseData, error) {
	resp, err := sendRpcRequestCallHelper[*dshrpc.CommandVarResponseData](w, "getvar", data, opts)
	return resp, err
}

// command "getwaveaichat", dshserver.GetWaveAIChatCommand
func GetWaveAIChatCommand(w *dshutil.WshRpc, data dshrpc.CommandGetWaveAIChatData, opts *dshrpc.RpcOpts) (*uctypes.UIChat, error) {
	resp, err := sendRpcRequestCallHelper[*uctypes.UIChat](w, "getwaveaichat", data, opts)
	return resp, err
}

// command "getwaveaimodeconfig", dshserver.GetWaveAIModeConfigCommand
func GetWaveAIModeConfigCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (dconfig.AIModeConfigUpdate, error) {
	resp, err := sendRpcRequestCallHelper[dconfig.AIModeConfigUpdate](w, "getwaveaimodeconfig", nil, opts)
	return resp, err
}

// command "getwaveairatelimit", dshserver.GetWaveAIRateLimitCommand
func GetWaveAIRateLimitCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (*uctypes.RateLimitInfo, error) {
...
func JobCmdExitedCommand(w *dshutil.WshRpc, data dshrpc.CommandJobCmdExitedData, opts *dshrpc.RpcOpts) error {
...
func JobControllerAttachJobCommand(w *dshutil.WshRpc, data dshrpc.CommandJobControllerAttachJobData, opts *dshrpc.RpcOpts) error {
...
func JobControllerConnectedJobsCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]string, error) {
...
func JobControllerDeleteJobCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
...
func JobControllerDetachJobCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
...
func JobControllerDisconnectJobCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
...
func JobControllerExitJobCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
...
func JobControllerGetAllJobManagerStatusCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]*dshrpc.JobManagerStatusUpdate, error) {
...
func JobControllerListCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]*doraobj.Job, error) {
...
func JobControllerReconnectJobCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
...
func JobControllerReconnectJobsForConnCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
...
func JobControllerStartJobCommand(w *dshutil.WshRpc, data dshrpc.CommandJobControllerStartJobData, opts *dshrpc.RpcOpts) (string, error) {
	resp, err := sendRpcRequestCallHelper[string](w, "jobcontrollerstartjob", data, opts)
	return resp, err
}

// command "jobinput", dshserver.JobInputCommand
func JobInputCommand(w *dshutil.WshRpc, data dshrpc.CommandJobInputData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "jobinput", data, opts)
	return err
}

// command "jobprepareconnect", dshserver.JobPrepareConnectCommand
func JobPrepareConnectCommand(w *dshutil.WshRpc, data dshrpc.CommandJobPrepareConnectData, opts *dshrpc.RpcOpts) (*dshrpc.CommandJobConnectRtnData, error) {
...
func JobStartStreamCommand(w *dshutil.WshRpc, data dshrpc.CommandJobStartStreamData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "jobstartstream", data, opts)
	return err
}

// command "listallappfiles", dshserver.ListAllAppFilesCommand
func ListAllAppFilesCommand(w *dshutil.WshRpc, data dshrpc.CommandListAllAppFilesData, opts *dshrpc.RpcOpts) (*dshrpc.CommandListAllAppFilesRtnData, error) {
...
func ListAllAppsCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]dshrpc.AppInfo, error) {
...
func ListAllEditableAppsCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]dshrpc.AppInfo, error) {
...
func MacOSVersionCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (string, error) {
...
func MakeDraftFromLocalCommand(w *dshutil.WshRpc, data dshrpc.CommandMakeDraftFromLocalData, opts *dshrpc.RpcOpts) (*dshrpc.CommandMakeDraftFromLocalRtnData, error) {
...
func MessageCommand(w *dshutil.WshRpc, data dshrpc.CommandMessageData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "message", data, opts)
	return err
}

// command "networkonline", dshserver.NetworkOnlineCommand
func NetworkOnlineCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (bool, error) {
	resp, err := sendRpcRequestCallHelper[bool](w, "networkonline", nil, opts)
	return resp, err
}

// command "notify", dshserver.NotifyCommand
func NotifyCommand(w *dshutil.WshRpc, data dshrpc.WaveNotificationOptions, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "notify", data, opts)
	return err
}

// command "notifysystemresume", dshserver.NotifySystemResumeCommand
func NotifySystemResumeCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "notifysystemresume", nil, opts)
	return err
}

// command "path", dshserver.PathCommand
func PathCommand(w *dshutil.WshRpc, data dshrpc.PathCommandData, opts *dshrpc.RpcOpts) (string, error) {
	resp, err := sendRpcRequestCallHelper[string](w, "path", data, opts)
	return resp, err
}

// command "publishapp", dshserver.PublishAppCommand
func PublishAppCommand(w *dshutil.WshRpc, data dshrpc.CommandPublishAppData, opts *dshrpc.RpcOpts) (*dshrpc.CommandPublishAppRtnData, error) {
...
func ReadAppFileCommand(w *dshutil.WshRpc, data dshrpc.CommandReadAppFileData, opts *dshrpc.RpcOpts) (*dshrpc.CommandReadAppFileRtnData, error) {
...
func RecordTEventCommand(w *dshutil.WshRpc, data telemetrydata.TEvent, opts *dshrpc.RpcOpts) error {
...
func RemoteDisconnectFromJobManagerCommand(w *dshutil.WshRpc, data dshrpc.CommandRemoteDisconnectFromJobManagerData, opts *dshrpc.RpcOpts) error {
...
func RemoteFileCopyCommand(w *dshutil.WshRpc, data dshrpc.CommandFileCopyData, opts *dshrpc.RpcOpts) (bool, error) {
...
func RemoteFileDeleteCommand(w *dshutil.WshRpc, data dshrpc.CommandDeleteFileData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "remotefiledelete", data, opts)
	return err
}

// command "remotefileinfo", dshserver.RemoteFileInfoCommand
func RemoteFileInfoCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) (*dshrpc.FileInfo, error) {
...
func RemoteFileJoinCommand(w *dshutil.WshRpc, data []string, opts *dshrpc.RpcOpts) (*dshrpc.FileInfo, error) {
...
func RemoteFileMoveCommand(w *dshutil.WshRpc, data dshrpc.CommandFileCopyData, opts *dshrpc.RpcOpts) error {
...
func RemoteFileMultiInfoCommand(w *dshutil.WshRpc, data dshrpc.CommandRemoteFileMultiInfoData, opts *dshrpc.RpcOpts) (map[string]dshrpc.FileInfo, error) {
...
func RemoteFileStreamCommand(w *dshutil.WshRpc, data dshrpc.CommandRemoteFileStreamData, opts *dshrpc.RpcOpts) (*dshrpc.FileInfo, error) {
...
func RemoteFileTouchCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "remotefiletouch", data, opts)
	return err
}

// command "remotegetinfo", dshserver.RemoteGetInfoCommand
func RemoteGetInfoCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (dshrpc.RemoteInfo, error) {
...
func RemoteInstallRcFilesCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) error {
...
func RemoteListEntriesCommand(w *dshutil.WshRpc, data dshrpc.CommandRemoteListEntriesData, opts *dshrpc.RpcOpts) chan dshrpc.RespOrErrorUnion[dshrpc.CommandRemoteListEntriesRtnData] {
...
func RemoteMkdirCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "remotemkdir", data, opts)
	return err
}

// command "remoteprocesslist", dshserver.RemoteProcessListCommand
func RemoteProcessListCommand(w *dshutil.WshRpc, data dshrpc.CommandRemoteProcessListData, opts *dshrpc.RpcOpts) (*dshrpc.ProcessListResponse, error) {
...
func RemoteProcessSignalCommand(w *dshutil.WshRpc, data dshrpc.CommandRemoteProcessSignalData, opts *dshrpc.RpcOpts) error {
...
func RemoteReconnectToJobManagerCommand(w *dshutil.WshRpc, data dshrpc.CommandRemoteReconnectToJobManagerData, opts *dshrpc.RpcOpts) (*dshrpc.CommandRemoteReconnectToJobManagerRtnData, error) {
...
func RemoteStartJobCommand(w *dshutil.WshRpc, data dshrpc.CommandRemoteStartJobData, opts *dshrpc.RpcOpts) (*dshrpc.CommandStartJobRtnData, error) {
...
func RemoteStreamCpuDataCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) chan dshrpc.RespOrErrorUnion[dshrpc.TimeSeriesData] {
...
func RemoteTerminateJobManagerCommand(w *dshutil.WshRpc, data dshrpc.CommandRemoteTerminateJobManagerData, opts *dshrpc.RpcOpts) error {
...
func RemoteWriteFileCommand(w *dshutil.WshRpc, data dshrpc.FileData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "remotewritefile", data, opts)
	return err
}

// command "renameappfile", dshserver.RenameAppFileCommand
func RenameAppFileCommand(w *dshutil.WshRpc, data dshrpc.CommandRenameAppFileData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "renameappfile", data, opts)
	return err
}

// command "resolveids", dshserver.ResolveIdsCommand
func ResolveIdsCommand(w *dshutil.WshRpc, data dshrpc.CommandResolveIdsData, opts *dshrpc.RpcOpts) (dshrpc.CommandResolveIdsRtnData, error) {
...
func RestartBuilderAndWaitCommand(w *dshutil.WshRpc, data dshrpc.CommandRestartBuilderAndWaitData, opts *dshrpc.RpcOpts) (*dshrpc.RestartBuilderAndWaitResult, error) {
...
func SetConnectionsConfigCommand(w *dshutil.WshRpc, data dshrpc.ConnConfigRequest, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "setconnectionsconfig", data, opts)
	return err
}

// command "setmeta", dshserver.SetMetaCommand
func SetMetaCommand(w *dshutil.WshRpc, data dshrpc.CommandSetMetaData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "setmeta", data, opts)
	return err
}

// command "setpeerinfo", dshserver.SetPeerInfoCommand
func SetPeerInfoCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "setpeerinfo", data, opts)
	return err
}

// command "setrtinfo", dshserver.SetRTInfoCommand
func SetRTInfoCommand(w *dshutil.WshRpc, data dshrpc.CommandSetRTInfoData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "setrtinfo", data, opts)
	return err
}

// command "setsecrets", dshserver.SetSecretsCommand
func SetSecretsCommand(w *dshutil.WshRpc, data map[string]*string, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "setsecrets", data, opts)
	return err
}

// command "setvar", dshserver.SetVarCommand
func SetVarCommand(w *dshutil.WshRpc, data dshrpc.CommandVarData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "setvar", data, opts)
	return err
}

// command "startbuilder", dshserver.StartBuilderCommand
func StartBuilderCommand(w *dshutil.WshRpc, data dshrpc.CommandStartBuilderData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "startbuilder", data, opts)
	return err
}

// command "startjob", dshserver.StartJobCommand
func StartJobCommand(w *dshutil.WshRpc, data dshrpc.CommandStartJobData, opts *dshrpc.RpcOpts) (*dshrpc.CommandStartJobRtnData, error) {
...
func StopBuilderCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "stopbuilder", data, opts)
	return err
}

// command "streamcpudata", dshserver.StreamCpuDataCommand
func StreamCpuDataCommand(w *dshutil.WshRpc, data dshrpc.CpuDataRequest, opts *dshrpc.RpcOpts) chan dshrpc.RespOrErrorUnion[dshrpc.TimeSeriesData] {
...
func StreamDataCommand(w *dshutil.WshRpc, data dshrpc.CommandStreamData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "streamdata", data, opts)
	return err
}

// command "streamdataack", dshserver.StreamDataAckCommand
func StreamDataAckCommand(w *dshutil.WshRpc, data dshrpc.CommandStreamAckData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "streamdataack", data, opts)
	return err
}

// command "streamtest", dshserver.StreamTestCommand
func StreamTestCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) chan dshrpc.RespOrErrorUnion[int] {
...
func TermGetScrollbackLinesCommand(w *dshutil.WshRpc, data dshrpc.CommandTermGetScrollbackLinesData, opts *dshrpc.RpcOpts) (*dshrpc.CommandTermGetScrollbackLinesRtnData, error) {
...
func TestCommand(w *dshutil.WshRpc, data string, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "test", data, opts)
	return err
}

// command "testmultiarg", dshserver.TestMultiArgCommand
func TestMultiArgCommand(w *dshutil.WshRpc, arg1 string, arg2 int, arg3 bool, opts *dshrpc.RpcOpts) (string, error) {
...
func UpdateTabNameCommand(w *dshutil.WshRpc, arg1 string, arg2 string, opts *dshrpc.RpcOpts) error {
...
func UpdateWorkspaceTabIdsCommand(w *dshutil.WshRpc, arg1 string, arg2 []string, opts *dshrpc.RpcOpts) error {
...
func VDomAsyncInitiationCommand(w *dshutil.WshRpc, data vdom.VDomAsyncInitiationRequest, opts *dshrpc.RpcOpts) error {
...
func VDomCreateContextCommand(w *dshutil.WshRpc, data vdom.VDomCreateContext, opts *dshrpc.RpcOpts) (*doraobj.ORef, error) {
...
func VDomRenderCommand(w *dshutil.WshRpc, data vdom.VDomFrontendUpdate, opts *dshrpc.RpcOpts) chan dshrpc.RespOrErrorUnion[*vdom.VDomBackendUpdate] {
...
func VDomUrlRequestCommand(w *dshutil.WshRpc, data dshrpc.VDomUrlRequestData, opts *dshrpc.RpcOpts) chan dshrpc.RespOrErrorUnion[dshrpc.VDomUrlRequestResponse] {
...
func WaitForRouteCommand(w *dshutil.WshRpc, data dshrpc.CommandWaitForRouteData, opts *dshrpc.RpcOpts) (bool, error) {
	resp, err := sendRpcRequestCallHelper[bool](w, "waitforroute", data, opts)
	return resp, err
}

// command "waveaiaddcontext", dshserver.WaveAIAddContextCommand
func WaveAIAddContextCommand(w *dshutil.WshRpc, data dshrpc.CommandWaveAIAddContextData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "waveaiaddcontext", data, opts)
	return err
}

// command "waveaienabletelemetry", dshserver.WaveAIEnableTelemetryCommand
func WaveAIEnableTelemetryCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "waveaienabletelemetry", nil, opts)
	return err
}

// command "waveaigettooldiff", dshserver.WaveAIGetToolDiffCommand
func WaveAIGetToolDiffCommand(w *dshutil.WshRpc, data dshrpc.CommandWaveAIGetToolDiffData, opts *dshrpc.RpcOpts) (*dshrpc.CommandWaveAIGetToolDiffRtnData, error) {
	resp, err := sendRpcRequestCallHelper[*dshrpc.CommandWaveAIGetToolDiffRtnData](w, "waveaigettooldiff", data, opts)
	return resp, err
}

// command "waveaitoolapprove", dshserver.WaveAIToolApproveCommand
func WaveAIToolApproveCommand(w *dshutil.WshRpc, data dshrpc.CommandWaveAIToolApproveData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "waveaitoolapprove", data, opts)
	return err
}

// command "wavefilereadstream", dshserver.WaveFileReadStreamCommand
func WaveFileReadStreamCommand(w *dshutil.WshRpc, data dshrpc.CommandWaveFileReadStreamData, opts *dshrpc.RpcOpts) (*dshrpc.WaveFileInfo, error) {
	resp, err := sendRpcRequestCallHelper[*dshrpc.WaveFileInfo](w, "wavefilereadstream", data, opts)
	return resp, err
}

// command "waveinfo", dshserver.WaveInfoCommand
func WaveInfoCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (*dshrpc.WaveInfoData, error) {
	resp, err := sendRpcRequestCallHelper[*dshrpc.WaveInfoData](w, "waveinfo", nil, opts)
	return resp, err
}

// command "webselector", dshserver.WebSelectorCommand
func WebSelectorCommand(w *dshutil.WshRpc, data dshrpc.CommandWebSelectorData, opts *dshrpc.RpcOpts) ([]string, error) {
	resp, err := sendRpcRequestCallHelper[[]string](w, "webselector", data, opts)
	return resp, err
}

// command "workspacelist", dshserver.WorkspaceListCommand
func WorkspaceListCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]dshrpc.WorkspaceInfoData, error) {
...
func WriteAppFileCommand(w *dshutil.WshRpc, data dshrpc.CommandWriteAppFileData, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "writeappfile", data, opts)
	return err
}

// command "writeappgofile", dshserver.WriteAppGoFileCommand
func WriteAppGoFileCommand(w *dshutil.WshRpc, data dshrpc.CommandWriteAppGoFileData, opts *dshrpc.RpcOpts) (*dshrpc.CommandWriteAppGoFileRtnData, error) {
...
func WriteAppSecretBindingsCommand(w *dshutil.WshRpc, data dshrpc.CommandWriteAppSecretBindingsData, opts *dshrpc.RpcOpts) error {
...
func WriteTempFileCommand(w *dshutil.WshRpc, data dshrpc.CommandWriteTempFileData, opts *dshrpc.RpcOpts) (string, error) {
	resp, err := sendRpcRequestCallHelper[string](w, "writetempfile", data, opts)
	return resp, err
}

// command "wshactivity", dshserver.WshActivityCommand
func WshActivityCommand(w *dshutil.WshRpc, data map[string]int, opts *dshrpc.RpcOpts) error {
	_, err := sendRpcRequestCallHelper[any](w, "wshactivity", data, opts)
	return err
}

// command "wsldefaultdistro", dshserver.WslDefaultDistroCommand
func WslDefaultDistroCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) (string, error) {
	resp, err := sendRpcRequestCallHelper[string](w, "wsldefaultdistro", nil, opts)
	return resp, err
}

// command "wsllist", dshserver.WslListCommand
func WslListCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]string, error) {
	resp, err := sendRpcRequestCallHelper[[]string](w, "wsllist", nil, opts)
	return resp, err
}

// command "wslstatus", dshserver.WslStatusCommand
func WslStatusCommand(w *dshutil.WshRpc, opts *dshrpc.RpcOpts) ([]dshrpc.ConnStatus, error) {
