...
To see how Wave's built-in backgrounds are defined, check out the [default backgrounds.json file](https://github.com/dfbb/doraterm/blob/main/pkg/wconfig/defaultconfig/backgrounds.json).
