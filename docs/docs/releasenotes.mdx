...
- **Drag & Drop Files into Terminal** - Drag files from Finder (macOS) or your file manager into a terminal block to paste their quoted path ([#746](https://github.com/dfbb/doraterm/issues/746))
...
**Other Changes:**
- Mobile user agent emulation support for web widgets [#2442](https://github.com/dfbb/doraterm/issues/2442)
- [bugfix] Fixed padding for header buttons in code editor (Tailwind regression)
- [bugfix] Restored syntax highlighting in code editor preview blocks [#2427](https://github.com/dfbb/doraterm/issues/2427)
- Package updates and dependency bumps
...
- [bugfix] Fix terminal theming when applying global defaults [#1287](https://github.com/dfbb/doraterm/issues/1287)
...
- CLI applications that need microphone, camera, or location access will now work on MacOS. You'll see a security popup in Wave to allow/deny [#1086](https://github.com/dfbb/doraterm/issues/1086)
...
- There is a new setting in the editor to enable/disable word wrapping [#1038](https://github.com/dfbb/doraterm/issues/1038)
- Ctrl-S will now save files in codeedit [#1081](https://github.com/dfbb/doraterm/issues/1081)
- [#1020](https://github.com/dfbb/doraterm/issues/1020) there is now a preset config option to change the active border color in tab themes
- [bugfix] Multiple fixes for [#1167](https://github.com/dfbb/doraterm/issues/1167) to try to address tab loss while updating
...
- [bugfix] [#1175](https://github.com/dfbb/doraterm/issues/1175) can now edit .awk files
- [bugfix] [#1066](https://github.com/dfbb/doraterm/issues/1066) applying a default theme now updates the background appropriately without a refresh
...
Lots of other smaller changes and bug fixes. See full list of PRs at https://github.com/dfbb/doraterm/releases/tag/v0.9.0
...
- Use DORATERM_HOME for the home directory consistently
...
Release Artificats and source code diffs can be found on (Github)[https://github.com/dfbb/doraterm].
