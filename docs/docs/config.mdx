...
```json
{
    ...
    "web:defaulturl": "https://github.com/dfbb/doraterm",
...
```json
{
  ...
  "bookmark@wave-github": {
    "url": "https://github.com/dfbb/doraterm",
    "title": "Wave Github",
  ...
  "bookmark@wave-pulls": {
    "url": "https://github.com/dfbb/doraterm/pulls",
...
Here is an example of defining a full terminal theme. All of the built-in themes are defined here: https://github.com/dfbb/doraterm/blob/main/pkg/wconfig/defaultconfig/termthemes.json (if you'd like to add a popular terminal theme, please submit a PR!)
