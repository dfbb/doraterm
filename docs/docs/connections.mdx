...
| DORATERM_BLOCKID     | The id of the block containing your current terminal widget.                  |
| DORATERM_CLIENTID    | The id of the RPC Client being used by your current terminal widget.          |
| DORATERM_CONN        | The name of the remote connection being used by your current terminal widget. |
| DORATERM_TABID       | The id of the tab containing your current terminal widget.                    |
| DORATERM_VERSION     | The current semver version of wave.                                           |
| DORATERM_WORKSPACEID | The id of thw workspace containing your current terminal widget.              |
