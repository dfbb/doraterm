...
ARM64 is planned, but is currently blocked by upstream dependencies (see [Windows ARM Support](https://github.com/dfbb/doraterm/issues/928)).
...
- Report issues on [GitHub](https://github.com/dfbb/doraterm/issues)
