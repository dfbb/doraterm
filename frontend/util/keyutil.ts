...
function isCharacterKeyEvent(event: DoraKeyboardEvent): boolean {
...
function isInputEvent(event: DoraKeyboardEvent): boolean {
...
function checkKeyPressed(event: DoraKeyboardEvent, keyDescription: string): boolean {
...
function adaptFromReactOrNativeKeyEvent(event: React.KeyboardEvent | KeyboardEvent): DoraKeyboardEvent {
    let rtn: DoraKeyboardEvent = {} as DoraKeyboardEvent;
...
function adaptFromElectronKeyEvent(event: any): DoraKeyboardEvent {
    let rtn: DoraKeyboardEvent = {} as DoraKeyboardEvent;
    if (event.type == "keyUp") {
        rtn.type = "keyup";
...
function keyboardEventToASCII(event: DoraKeyboardEvent): string {
    // check modifiers
