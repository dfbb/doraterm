...
function createMockFilesystemEntries(): MockFsEntryInput[] {
    const entries: MockFsEntryInput[] = [
        ...
        { path: `${MockHomePath}/doraterm`, isdir: true },
        { path: `${MockHomePath}/doraterm/docs`, isdir: true },
        { path: `${MockHomePath}/doraterm/images`, isdir: true },
        ...
        makeMockFsInput(`${MockHomePath}/Downloads/doraterm-nightly.dmg`),
        ...
        makeMockFsInput(
            `${MockHomePath}/doraterm/README.md`,
            `# Mock DoraTerm Repo\n\nThis fake repo exists only in the preview environment.\nIt gives file previews something realistic to browse.\n`,
            "text/markdown"
        ),
        makeMockFsInput(`${MockHomePath}/doraterm/package.json`),
        makeMockFsInput(`${MockHomePath}/doraterm/tsconfig.json`),
        makeMockFsInput(`${MockHomePath}/doraterm/Taskfile.yml`),
        makeMockFsInput(`${MockHomePath}/doraterm/preview-model.tsx`),
        makeMockFsInput(`${MockHomePath}/doraterm/mockdoraenv.ts`),
        makeMockFsInput(`${MockHomePath}/doraterm/vite.config.ts`),
        makeMockFsInput(`${MockHomePath}/doraterm/CHANGELOG.md`),
        makeMockFsInput(
            `${MockHomePath}/doraterm/docs/preview-notes.md`,
        ...
        makeMockFsInput(`${MockHomePath}/doraterm/docs/filesystem-rpc.md`),
        makeMockFsInput(`${MockHomePath}/doraterm/docs/test-plan.md`),
        makeMockFsInput(`${MockHomePath}/doraterm/docs/connections.md`),
        makeMockFsInput(`${MockHomePath}/doraterm/docs/preview-gallery.md`),
        makeMockFsInput(`${MockHomePath}/doraterm/docs/release-notes.md`),
        makeMockFsInput(`${MockHomePath}/doraterm/images/dora-logo.png`, TinyPngBytes, "image/png"),
        makeMockFsInput(`${MockHomePath}/doraterm/images/hero.png`),
        makeMockFsInput(`${MockHomePath}/doraterm/images/avatar.jpg`),
        makeMockFsInput(`${MockHomePath}/doraterm/images/icon-16.png`),
        makeMockFsInput(`${MockHomePath}/doraterm/images/icon-32.png`),
        makeMockFsInput(`${MockHomePath}/doraterm/images/splash.jpg`),
        makeMockFsInput(
