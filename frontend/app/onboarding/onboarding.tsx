    ...
    return (
        <div className="flex flex-col h-full">
            ...
            >
                ...
                <div className="text-center text-[25px] font-normal text-foreground">Welcome to Dora Terminal</div>
            </header>
                ...
                <div className="flex flex-col items-start gap-8 w-full mb-5 unselectable">
                    <div className="flex w-full items-center gap-[18px]">
                        <div>
                            <a
                                target="_blank"
                                href="https://github.com/dfbb/doraterm?ref=install"
                                rel="noopener"
