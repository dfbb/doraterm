...
import waveLogo from "/logos/dora-logo.png";
...
export const ViewLogoCommand = ({ onComplete }: { onComplete?: () => void }) => {
    return (
        <FakeCommand command="wsh view public/dora-logo.png" onComplete={onComplete}>
            <FakeBlock icon="image" name="dora-logo.png" imgsrc={waveLogo} />
        </FakeCommand>
    );
};
