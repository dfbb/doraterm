...
import { DoraBrowserWindow } from "./emain-window";

export function getWebContentsByBlockId(ww: DoraBrowserWindow, tabId: string, blockId: string): Promise<WebContents> {
