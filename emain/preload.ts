...
contextBridge.exposeInMainWorld("api", {
    ...
    onReinjectKey: (callback) => ipcRenderer.on("reinject-key", (_event, doraEvent) => callback(doraEvent)),
    ...
    onDoraInit: (callback) => ipcRenderer.on("dora-init", (_event, initOpts) => callback(initOpts)),
