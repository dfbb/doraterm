# Building Dora Terminal

These instructions are for setting up dependencies and building Dora Terminal from source on macOS, Linux, and Windows.
...
```sh
git clone git@github.com:doratermdev/doraterm.git
```

or

```sh
git clone https://github.com/doratermdev/doraterm.git
```
