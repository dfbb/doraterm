...
import (
	...
	"github.com/dfbb/doraterm/pkg/aiusechat"
	"github.com/dfbb/doraterm/pkg/aiusechat/uctypes"
	"github.com/dfbb/doraterm/pkg/web/sse"
)
...
func testOpenAI(ctx context.Context, model, message string, tools []uctypes.ToolDefinition) {
	...
	// Convert to AIMessage format for DoraAIPostMessageWrap
	...
	fmt.Printf("Testing OpenAI streaming with DoraAIPostMessageWrap, model: %s\n", model)
	...
	chatOpts := uctypes.DoraChatOpts{
		ChatId:   chatID,
		ClientId: uuid.New().String(),
		Config:   *opts,
		Tools:    tools,
	}
	err := aiusechat.DoraAIPostMessageWrap(ctx, sseHandler, aiMessage, chatOpts)
	if err != nil {
...
func testOpenAIComp(ctx context.Context, model, message string, tools []uctypes.ToolDefinition) {
	...
	fmt.Printf("Testing OpenAI Completions API with DoraAIPostMessageWrap, model: %s\n", model)
	fmt.Printf("Message: %s\n", message)
	fmt.Printf("Chat ID: %s\n", chatID)
	fmt.Println("---")
...
func testOpenRouter(ctx context.Context, model, message string, tools []uctypes.ToolDefinition) {
	...
	fmt.Printf("Testing OpenRouter with DoraAIPostMessageWrap, model: %s\n", model)
	fmt.Printf("Message: %s\n", message)
	fmt.Printf("Chat ID: %s\n", chatID)
	fmt.Println("---")
...
func testNanoGPT(ctx context.Context, model, message string, tools []uctypes.ToolDefinition) {
	...
	fmt.Printf("Testing NanoGPT with DoraAIPostMessageWrap, model: %s\n", model)
	fmt.Printf("Message: %s\n", message)
	fmt.Printf("Chat ID: %s\n", chatID)
	fmt.Println("---")
...
func testAnthropic(ctx context.Context, model, message string, tools []uctypes.ToolDefinition) {
	...
	fmt.Printf("Testing Anthropic streaming with DoraAIPostMessageWrap, model: %s\n", model)
	fmt.Printf("Message: %s\n", message)
	fmt.Printf("Chat ID: %s\n", chatID)
	fmt.Println("---")
...
func testGemini(ctx context.Context, model, message string, tools []uctypes.ToolDefinition) {
	...
	fmt.Printf("Testing Google Gemini streaming with DoraAIPostMessageWrap, model: %s\n", model)
	fmt.Printf("Message: %s\n", message)
	fmt.Printf("Chat ID: %s\n", chatID)
	fmt.Println("---")
